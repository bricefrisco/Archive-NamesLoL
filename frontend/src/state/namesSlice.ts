...
export const getSummonersHaveLoaded = (state: any) =>
  state.names.apiSummoners.loaded;
export const getSummonerLoading = (state: any) =>
  state.names.apiSummoner.loading;
export const getSummonersLoading = (state: any) =>
  state.names.apiSummoners.loading;
...
export const fetchSummoners = (timestamp: number, backwards: boolean) => (
  ...
  fetch(url.toString())
    ...
    .then((response) => {
      ...
      dispatch(
        setPage({ forwards: response.forwards, backwards: response.backwards })
      );
    })
